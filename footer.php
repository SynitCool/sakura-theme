    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
         ...
         <a href="/wordpress"><img src="https://sman1cikarangutara.sch.id/wp-content/uploads/2023/05/logo-smansa-default-2.png" alt="logo" /></a>
         <hr />
         <p>
        ...
        <div class="col-md-5 col-lg-4 col-xl-4 mx-auto mb-md-0 mb-4">
          ...
          <p>
            <i class="fa fa-envelope me-3"></i>
             bryan@sman1cikarangutara.sch.id
          </p>
          <p><i class="fa fa-phone me-3"></i> 0812-8882-0429/0856-9062-787</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
